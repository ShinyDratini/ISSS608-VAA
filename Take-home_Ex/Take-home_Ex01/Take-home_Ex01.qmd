...
```
No Clear Linear Relationship Between Distance & Turnaround Time
Across all route types, there is no strong linear correlation between distance traveled and turnaround time.
Ships covering short and long distances seem to experience similar turnaround times, indicating that other operational factors (port efficiency, ship size, delays, weather, etc.) may contribute to turnaround time.
2. Cargo Weight Distribution is Fairly Even
Across all routes, cargo weight is widely distributed across different distances and turnaround times.
Heavier cargo (darker blue points) is seen in all ranges of turnaround time and distance, suggesting that cargo weight alone does not significantly influence turnaround time.
3. Shorter Routes Have High Variability in Turnaround Time
Coastal & Short-haul routes (top-left & bottom-left plots) show wide spread turnaround times even for shorter distances.
This suggests that factors other than distance, such as port congestion, waiting times, or operational delays, could be affecting turnaround time.
4. Long-haul & Transoceanic Routes Have More Evenly Distributed Turnaround Times
Long-haul & Transoceanic routes (top-right & bottom-right plots) show relatively balanced distributions.
Ships covering longer distances (>1000 nm) still experience a mix of long and short turnaround times, reinforcing that turnaround time is influenced by multiple factors beyond distance traveled.
